...
- **Work IQ**: The intelligence layer that personalizes Microsoft 365 Copilot to you and your organization; understanding context, relationships, and work patterns so agents can be faster, more accurate, and more secure.
...
| [Work IQ: The Intelligence Layer Behind Copilot & Agents](./Work-IQ/1-Work-IQ-The-Intelligence-Layer-Behind-Copilot-and-Agents/README.md)       | Introduces Work IQ architecture and protocol strategy across REST, A2A, and MCP for enterprise agent experiences. | coming soon | [Lab](./Work-IQ/1-Work-IQ-The-Intelligence-Layer-Behind-Copilot-and-Agents/lab/) |
| [Work IQ: A2A for Context‑Aware, Agentic Experiences](./Work-IQ/2-Work-IQ-A2A-for-Context‑Aware-Agentic-Experiences/README.md)                  | Explores the A2A protocol, agent discovery patterns, and practical prototyping for context-aware agentic workflows. | coming soon | [Lab](./Work-IQ/2-Work-IQ-A2A-for-Context‑Aware-Agentic-Experiences/lab/) |
| [Work IQ: Tooling with MCP & Copilot CLI](./Work-IQ/3-Work-IQ-Tooling-with-MCP-and-Copilot-CLI/README.md)                                      | Shows how to set up Work IQ CLI and use MCP with GitHub Copilot CLI to enable actionable intelligence workflows. | coming soon | [Lab](./Work-IQ/3-Work-IQ-Tooling-with-MCP-and-Copilot-CLI/lab/) |
...
1. Capture a final output screenshot for each episode
...
1. Fork this repo and save your lab outputs as screenshot for each episode
